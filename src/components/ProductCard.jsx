  ...
  return (
    <div className="group relative aspect-[3/4] bg-gray-900 rounded-lg overflow-hidden shadow-lg transition-all duration-300">
      ...
      <div className="absolute inset-0 p-4 md:p-6 flex flex-col">
        ...
        {/* 1. "Sticker" Harga di Pojok Kanan Atas */}
        ...
        {/* Spacer untuk mendorong judul ke bawah */}
        <div className="flex-grow"></div>
        
        {/* 2. Judul Produk yang Overlapping di Bawah */}
        ...
        {/* 3. Tombol Ikon yang Muncul di Pojok */}
        <div className="absolute bottom-4 right-4">
          <button className="w-12 h-12 flex items-center justify-center bg-white text-black rounded-full transform scale-75 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-300 ease-in-out">
            <ShoppingBag size={24} />
          </button>
        </div>
      </div>
